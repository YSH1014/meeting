...
from flask import render_template, current_app, request, copy_current_request_context, redirect, url_for
...
def user_required(func):
    ...
    def decorated_view(*args, **kwargs):
        if current_user.is_authenticated:
            ...
            return redirect(url_for('unauthorized', role_require=RoleType.USER))
